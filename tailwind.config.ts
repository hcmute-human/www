  ...
  theme: {
    extend: {
      colors: {
        ...
        accent: {
          50: 'color(display-p3 var(--theme-accent-50) / <alpha-value>)',
          100: 'color(display-p3 var(--theme-accent-100) / <alpha-value>)',
          200: 'color(display-p3 var(--theme-accent-200) / <alpha-value>)',
          300: 'color(display-p3 var(--theme-accent-300) / <alpha-value>)',
          400: 'color(display-p3 var(--theme-accent-400) / <alpha-value>)',
          500: 'color(display-p3 var(--theme-accent-500) / <alpha-value>)',
          600: 'color(display-p3 var(--theme-accent-600) / <alpha-value>)',
          700: 'color(display-p3 var(--theme-accent-700) / <alpha-value>)',
          800: 'color(display-p3 var(--theme-accent-800) / <alpha-value>)',
          900: 'color(display-p3 var(--theme-accent-900) / <alpha-value>)',
          950: 'color(display-p3 var(--theme-accent-950) / <alpha-value>)',
        },
        negative: {
