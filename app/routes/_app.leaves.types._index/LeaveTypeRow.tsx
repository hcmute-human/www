...
export default function EmployeeRow({ row }: Props) {
  ...
  return (
    <Row className={clsx(isDeleting && 'hidden')}>
      ...
      <Cell key="name" className="flex gap-x-2 justify-between flex-wrap">
        {row.getValue<string>('name')}
        {isDeletionFailed ? <InlineAlert variant="negative" iconPlacement="right" text={t('deletionFailed')} /> : null}
      </Cell>
